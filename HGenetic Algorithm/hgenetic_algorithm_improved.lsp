...
(defun exists_optimal_solution () ( 
									 let (( fitters (EVAL (defparameter *best_chromosomes* (parent_selection_2)   )) ))
...
(defun get_optimal_solution () (IF  (= (fitness_score (FIRST *best_chromosomes*))  0 )  
									(FIRST *best_chromosomes*)
									(SECOND *best_chromosomes*)
								)
)
...
(defun algorithm_2 () ( mutation_2 (crossover (FIRST  *best_chromosomes* ) (SECOND *best_chromosomes* ) ) )	)
...
(defun choose_algorithm () ( IF  (OR  (> (fitness_score (FIRST  *best_chromosomes* ) ) 4)  (> (fitness_score (SECOND  *best_chromosomes* )) 4) )     
